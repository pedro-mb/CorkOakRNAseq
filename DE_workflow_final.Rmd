...
### Run multigroup comparison analysis (Likelihood ratio test, ANOVA-like)
...
Run DESeq function for pairwise DE analysis WD vs WD
```{r}
...
#allDEGs <- unique(c(rownames(resSig_CorkDrought),rownames(resSig_PhloemDrought), rownames(resSig_XylemDrought)))
corkDEGs <- rownames(resSig_CorkDrought)
# get general matrix with normalized counts for all expressed genes
